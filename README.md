...
2. Compile and run the MIPS32 processor simulator using [compiler/interpreter command].
...
[List any dependencies or libraries required to run the simulator, if applicable.]

## Acknowledgements

[If you used any external resources or references, acknowledge them here.]
